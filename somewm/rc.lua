...
local global_keybinds = require("bindings.global.key")
local global_mousebinds = require("bindings.global.mouse")
local client_keybinds = require("bindings.client.key")
local client_mousebinds = require("bindings.client.mouse")
...
-- Mouse bindings
awful.mouse.append_global_mousebindings(global_mousebinds)
...
client.connect_signal("request::default_mousebindings", function()
    awful.mouse.append_client_mousebindings(client_mousebinds)
end)
