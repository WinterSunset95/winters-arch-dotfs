...
function Workspaces() {
  ...
  let focused = hyprland.get_focused_workspace()
  const workspaces = createBinding(hyprland, "workspaces",)((p) => p.sort((a, b) => a.id - b.id))
  const clients = createBinding(hyprland, "clients",)

  return (
    <For each={workspaces}>
      {(workspace) => (
        <button onClicked={() => hyprland.dispatch("workspace", workspace.get_id().toString())}>
